...
from app.fac.models import Cliente,FacturaEnc,FacturaDet
from django.views import generic
from django.contrib.messages.views import SuccessMessageMixin
from django.urls import reverse_lazy
from django.contrib.auth.decorators import login_required,permission_required
from app.bases.views import SinPrivilegios
from app.fac.forms import ClienteForm
from django.http import HttpResponse
from datetime import datetime
from django.contrib import messages
import app.inv.views as inv
...
def facturas(request,id=None):
    ...
    if request.method == "POST":
        ...
        if not id:
            messages.error(request,'No puedo Continuar No puede Detectar No. de Factura')
